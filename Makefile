...
test_BigInt.o: test_BigInt.cpp TestUtils.h BigInt.h
	g++ test_BigInt.cpp -std=c++17 -fsanitize=address -DDEBUG_BIG_INT -DDEBUG_CALCULATOR -DDEBUG_TEST_UTILS -c -o test_BigInt.o
...
test_Calc.o:  test_Calc.cpp calculator.h BigInt.h TestUtils.h
